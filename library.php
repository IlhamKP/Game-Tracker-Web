            ...
            <div class="popup">
                <form action="tambah-game.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="popup-isi">
                        ...
                        <label>Status</label>
                        <select class="platform" name="st">
                            <option>Belum dimainkan</option>
                            <option>Sedang dimainkan</option>
                            <option>Tamat</option>
                        </select>
                        <label>Rating</label>
                        <input type="number" placeholder="1-10" class="input-tg" name="rating">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <div class="library" id="library">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ?>
                <div class="card-game">
                    <img src="gambar-game/<?php echo $row['cover']; ?>">
                    <div class="info-game">
